...
class TestDashboardPage:
    ...
    def test_dashboard_shows_top_consumers(self, page: Page, app_server: str):
        ...
        expect(page.get_by_role("link", name="Production API Access").first).to_be_visible()
...
class TestSubscriptionsPage:
    ...
    def test_click_subscription_opens_detail(self, page: Page, app_server: str):
        ...
        expect(page.get_by_role("heading", name="Production API Access")).to_be_visible()
...
class TestSubscriptionDetailPage:
    ...
    def test_subscription_shows_daily_usage_table(self, page: Page, app_server: str):
        ...
        page.wait_for_selector("table:below(:text('Daily Usage Details'))", timeout=5000)
    ...
    def test_suspend_button_visible_for_active_subscription(self, page: Page, app_server: str):
    ...
    def test_activate_button_visible_for_suspended_subscription(self, page: Page, app_server: str):
        """Test that activate button is visible for suspended subscriptions."""
        page.goto(f"{app_server}/subscriptions/sub-003")  # Testing Environment is suspended
...
class TestNavigation:
    ...
    def test_navbar_links(self, page: Page, app_server: str):
        ...
        expect(page.get_by_role("link", name="Subscriptions", exact=True)).to_be_visible()
